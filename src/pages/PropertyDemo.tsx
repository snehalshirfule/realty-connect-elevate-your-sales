...
const PropertyDemoPage = () => {
  ...
  const updateParams = (template: TemplateId, theme: PropertyTheme) => {
    setSearchParams({ template, theme });
  };

  const handleTemplateChange = (t: TemplateId) => {
    setActiveTemplate(t);
    updateParams(t, activeTheme);
  };

  const handleThemeChange = (t: PropertyTheme) => {
    setActiveTheme(t);
    updateParams(activeTemplate, t);
  };

  const data = { ...sampleProperty, theme: activeTheme };
